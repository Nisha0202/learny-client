...
// export default function StripePaymentForm({ session }) {
...
//     }
//     //confirm-payment
//    const {error: confirmError, paymenIntent} = await stripe.confirmCardPayment( clientSecret, {
//       payment_method: {
//           card : card,
//           billing_details: {
//             email: usern.email,
...
//     if(paymenIntent.status === "succeeded"){
//       console.log(paymenIntent);
//       const paymentInfo = {
//         ...session,
//         transactionId : paymenIntent.id,
//         date: new Date(),
//       }
//       console.log(paymentInfo);
//     }
